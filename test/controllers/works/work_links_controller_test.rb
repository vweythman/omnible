...
module Works
  class WorkLinksControllerTest < ControllerTestCase
    ...
    test "should create link" do
      ...
      assert_redirected_to work_link_path(assigns(:link))
    end
    ...
    test "should update link" do
      sign_in @indra
      patch :update, id: @zoologist.id, work_link: {
        title: @viperfish.title
      }
      assert_redirected_to work_link_path(@zoologist)
    end
